...
public class SendEmailCustomerAdvertAction extends ActionSupport {
	...
	public  String show(){
		...
		System.out.println(this.areaId);
	...
	private List<CustomerMode> parseToCustomer(List<Customer> lc){
		...
		for(Customer customer :lc){
			...
			customerMode.setRealName("未知");
			if(customer.getRealName()!=null)customerMode.setRealName(customer.getRealName());
