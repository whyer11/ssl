...
public class SendEmailStoreAdvertAction extends ActionSupport {
	...
	public String show(){		
		...
		List<Store> ls =storeDao.findAll(this.pageNumber,this.pageSize, this.areaId);
		if(ls!=null)
		storeList=this.parseToStoreMode(ls);		
		return SUCCESS;
	}
