		...
		<div class="content-box">
			...
			<div class="content-box-content">
			  ...
			  <ul class="ui-select-content hide ui-ul-li"  id ="whyer" style="position:absolute;">
				<li class="ui-select-item"><a href="admin/storeDeal_list.html?selectValue=crateTime&unDeleted=${unDeleted}&hasDeleted=${hasDeleted}&searchClause=${searchClause}">按时间</a></li>
						...
						<tbody>
							<s:iterator value="lists">
								<tr>
									...
									<td><a
										href="admin/storeDeal_shows.html?storeId=<s:property value="storeId"/>&pageIndex=${pageIndex}&selectValue=${selectValue}"><s:property value="name" /></a></td>
									<td class="auto-hidden-text" style="max-width: 230px;"><s:iterator value="areaStores"> <s:property value="area.name"/></s:iterator></td>
									<th>${sendorno==0?"否":"是"}</th>
									...
									<td><a
										...
										<a href="admin/productA_list.html?storeId=<s:property value="storeId"/>">商品</a>
										<a href="admin/productA_add.html?storeId=<s:property value="storeId"/>">添加商品</a>									
										<a
