...
<link rel="stylesheet" href="/css/arale_btn.css" />
						...
						new AutoComplete(
								{
									...
									classPrefix : 'ui-select',
									dataSource : '/adminjson/jsondeal_categoryInfo.html?vcategory={{query}}'
		...
		<div class="content-box">
			...
			<div class="content-box-content">
				<s:form class="ui-form" name="" method="post"
					action="productA_Smodified" namespace="/admin" id="test-form">
					<legend></legend>
					<!-- 修改数据默认填入对话框 -->
					<s:iterator value="product">
						...
						<div class="ui-form-item">
							<label for="" class="ui-label"> <span
								...
								value='<s:property value="name"/>' id="goodsName">
						...
						<div class="ui-form-item ui-form-item-error">
							<label for="" class="ui-label">所在商家</label> <input
								...
								value='<s:property value="store.name"/>${storeName}' disabled="disabled">
						...
						<div class=" ui-form-item-success ui-form-item-focus"
							...
							<a tabindex="0" href="#news-items-2"
								...
								id="menuSelection">${category.name==null?"选择分类":category.name}</label>
							</a>
						...
						<br>
						<!-- 上传商品图片开始 -->
						<div class=" ui-form-item-success ui-form-item-focus uploadImg" style="margin-left: 100px;">
							<div>
							<input type="hidden" id="hidImgName" /> 
							<span	class="ui-button-morange ui-button" >
							<input	class="ui-button-text" id="btnUploadImg" value="上传"
								...
								<br>								
							<div>
								<img id="imgShow1" style="float:left;" border="0" /> 
								<img id="imgShow2"style="float:left;"/> 
								<img id="imgShow3" style="float:left;"/>
								<img id="imgShow4" style="float:left;"/>
							</div>
						</div>
						<!-- 上传商品图片结束 -->
						<br/>
						<div class="ui-form-item ui-form-item-success" style="clear: both;">
							<label for="" class="ui-label">商品描述</label>
							<textarea class="ui-textarea" name="pdescription"
								style="width: 427px; height: 122px; float:left;"><s:property
									value="description" /></textarea>

						</div>
						<div class="ui-form-item ui-form-item-error">
							<label for="" class="ui-label">商品价</label> <input name="pprice"
								class="ui-input" type="text" value='<s:property value="price"/>' id="goodsPrice" >
						...
						<div class="ui-form-item ui-form-item-error">
							<label for="" class="ui-label">是否团购</label> 是<input type="radio" value="1" id="tuanSele1"
								name="tuanRadio">否<input type="radio" name="tuanRadio" value="2" id="tuanSele2"
								checked="checked">
						</div>
						
						<div class="ui-form-item ui-form-item-error "  id="showTuan" style="display: none;">
							<label for="" class="ui-label">团购价格:</label><input class="ui-input" name="tuanPrice" type="text"> 
						</div>
