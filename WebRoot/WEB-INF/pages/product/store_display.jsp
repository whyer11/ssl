					...
					<div class="company_list t15">
						...
						<dl>
							...
							<dd>
								...
								<ul>
									<li><div class="price"><s:property value="store.shipPrice"/> 元起送</div>
										<div class="values">外送费<s:property value="store.shipFee"/>元</div>
										<div class="times">
											<s:property value="reachTime" />
											小时左右到达
										</div></li>
									<li><div class="address">地址：<s:property value="store.address"/></div></li>
									<li class="list_comment"><h5>口味<s:property value="store.environmentScore"/>颗星：</h5>
										<h5 class="mr15 star-5"></h5>
										<h5>服务<s:property value="store.serviceScore"/>颗星 ：</h5>
										<h5 class="mr15 star-5"></h5>
										<h5>速度<s:property value="store.speedScore"/>颗星：</h5>
...
<div class="company_list t15">
	<dl>	
						...
						<dd>
							...
							<ul>
								<li><div class="price">{{store.shipPrice}}元起送</div>
									<div class="values">外送费{{store.shipFee}}元</div>
									<div class="times">
										{{reachTime}}
										小时左右到达
									</div></li>
								<li><div class="address">地址：南京体育学院</div></li>
								<li class="list_comment"><h5>口味{{store.serviceScore}}颗星；</h5>
									<h5 class="mr15 star-5"></h5>
									<h5>服务{{store.serviceScore}}颗星：</h5>
									<h5 class="mr15 star-5"></h5>
									<h5>速度{{store.speedScore}}颗星：</h5>
									<h5 class="mr15 star-5"></h5></li>
							</ul>
							<span> <a href="store_storeDetail.html?storedetailId={{store.storeId}}"><img
